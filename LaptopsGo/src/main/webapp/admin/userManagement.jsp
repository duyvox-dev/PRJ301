<%-- 
    ...
    Created on : Jul 14, 2022, 3:16:13 PM
    Author     : vobao
--%>
...
<html>
    <head>
        ...
        <title>User Management - LaptopsGo</title>
    ...
    <body>
        ...
        <div>
            ...
            <div class="container">
                <h2 class="checkout__heading">User Management</h2>
                ...
                <form action="${pageContext.request.contextPath}/Admin/user" method="GET">
                    <div class="input__group">
                        ...
                        <div class="d-flex  align-items-center">
                            <label for="searchKey" class="d-block text-danger text-xl-start mr-5">Search by username </label>
                        ...
                        <tbody>
                            ...
                            <c:forEach var="o" items="${users}"> 
                                ...
                                <tr>
                                    ...
                                    <td>${o.getFullname()}</td>
                                    <td>
                                        <a class="btn btn__solid-red"  href="${pageContext.request.contextPath}/Admin/user?action=ban&userID=${o.getId()}">Ban</a>
                                    </td>
                                </tr> 
                            </c:forEach>
                        </tbody>
